(() => {
  ...
  function addReadability(){
    ...
    const style=document.createElement('style');style.id='magsta-readability';style.textContent=`
      ...
      body{font-size:16px;letter-spacing:.005em}.container{width:min(1180px,calc(100% - 40px))}.site-header{box-shadow:0 4px 18px rgba(0,0,0,.18)}.site-header nav a{transition:color .18s ease,opacity .18s ease}.hero-text,.page-hero p:last-child,.article-lead{max-width:760px;line-height:1.9}.section-heading{margin-bottom:22px}.section-heading h2,.side-heading h2{font-size:1.65rem}.section-heading h2:after,.side-heading h2:after{content:'';display:block;width:34px;height:3px;margin-top:8px;border-radius:3px;background:var(--accent)}.article-card,.side-card{box-shadow:0 8px 28px rgba(0,0,0,.14)}.featured{padding:32px;box-shadow:0 12px 36px rgba(0,0,0,.2)}.featured h3{font-size:1.7rem;line-height:1.45}.compact{padding:22px 24px}.compact h2,.compact h3{font-size:1.05rem;line-height:1.55}.article-card p,.side-lead,.about p{line-height:1.85}.topic{padding:20px 4px}.topic b{font-size:.96rem;line-height:1.55}.topic small{display:block;margin-top:3px;line-height:1.5}.filter{gap:10px;margin-bottom:24px}.filter a{padding:8px 14px;font-weight:700;transition:.18s ease}.filter a.active{box-shadow:0 4px 14px rgba(117,216,255,.18)}.page-hero{padding:76px 0 58px}.page-hero h1{margin-bottom:16px}.article-page{max-width:860px}.article-body{font-size:1.04rem;line-height:1.95}.article-body h2{font-size:1.55rem;line-height:1.4;padding-left:12px;border-left:3px solid var(--accent);margin-top:48px}.article-body p{margin:1em 0}.article-body li{line-height:1.8}.notice{line-height:1.8;background:var(--panel2)}.pickup-grid{gap:16px}.pickup-card{padding:22px;box-shadow:0 8px 24px rgba(0,0,0,.14)}.pickup-info h3{font-size:1.12rem;line-height:1.45}.pickup-info p{font-size:.8rem;line-height:1.8}.button{min-height:44px;display:inline-flex;align-items:center;justify-content:center}.read-more,.side-link,.more{font-size:.8rem}
      @media(max-width:800px){body{font-size:15.5px}.container{width:min(100% - 28px,1180px)}.hero-inner{padding:58px 0}.hero-text{font-size:1rem;line-height:1.85}.section-heading h2,.side-heading h2{font-size:1.42rem}.featured{padding:24px}.featured h3{font-size:1.35rem}.compact{padding:19px 20px}.page-hero{padding:54px 0 42px}.article-body{font-size:1rem;line-height:1.9}}
